...
abstract CommandAllocator(Resource) {
	...
	static function create(type:CommandListType):Resource {
		return null;
	}
}
...
abstract CommandList(Resource) {
	...
	public function drawIndexedInstanced(indexCountPerInstance:Int, instanceCount:Int, startIndexLocation:Int, baseVertexLocation:Int,
	...
	static function create(type:CommandListType, alloc:CommandAllocator, state:PipelineState):Resource {
		return null;
	}
}
...
abstract Fence(Resource) {
	...
	static function create(value:Int64, flags:FenceFlags):Resource {
		return null;
	}
}
...
abstract ShaderCompiler(hl.Abstract<"dx_compiler">) {
	...
	static function create():ShaderCompiler {
		return null;
	}
}
...
abstract DescriptorHeap(Resource) to Resource {
	...
	static function create(desc:DescriptorHeapDesc):Resource {
		return null;
	}
}
...
abstract RootSignature(Resource) {
	...
	static function create(bytes:hl.Bytes, len:Int):Resource {
		return null;
	}
}
...
abstract Bool32(Int) {
	...
	@:from static inline function fromBool(b:Bool):Bool32 {
		return cast b ? 1 : 0;
	};
}
...
class Dx12 {
	...
	public static function getCopyableFootprints(srcDesc:ResourceDesc, firstSubResource:Int, numSubResources:Int, baseOffset:Int64,
		layouts:PlacedSubresourceFootprint, numRows:hl.BytesAccess<Int>, rowSizeInBytes:hl.BytesAccess<Int64>, totalBytes:hl.BytesAccess<Int64>):Void {}

	public static function createSampler(desc:SamplerDesc, target:Address) {}

	public static function createCommittedResource(heapProperties:HeapProperties, heapFlags:haxe.EnumFlags<HeapFlag>, desc:ResourceDesc,
			initialState:ResourceState, clearValue:ClearValue):GpuResource {
		return null;
	}
	...
	public static function updateSubResource(commandList:CommandList, dst:GpuResource, src:GpuResource, srcOffset:Int64, first:Int, count:Int,
			data:SubResourceData):Bool {
		return false;
	}
